...
export class LoginService {
  private loginUrl = 'http://127.0.0.1:8000/gestion/Administradores/validar_usuario/'; // Asegúrate de que esta sea la ruta correcta de tu API
  private registerUrl = 'http://127.0.0.1:8000/gestion/Administradores/';
